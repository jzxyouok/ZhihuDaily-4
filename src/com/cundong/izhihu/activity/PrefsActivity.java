...
public class PrefsActivity extends SherlockPreferenceActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		boolean noImgnoWifi = PreferenceManager.getDefaultSharedPreferences(this).getBoolean(PREFERENCE_NOIMAGE_NOWIFI, false);
		findPreference(PREFERENCE_NOIMAGE_NOWIFI).setDefaultValue(noImgnoWifi);
		boolean darkTheme = PreferenceManager.getDefaultSharedPreferences(this).getBoolean(PREFERENCE_DARK_THEME, false);
...
//			showDialog(false);
	...
	private void showDialog( boolean isVersion ) {
		...
		if (isVersion) {
			...
			String subTitle = new StringBuilder().append(getResources().getString(R.string.app_sub_name)).append(PhoneUtils.getPackageInfo(this).versionName).append("<br/>").toString();
