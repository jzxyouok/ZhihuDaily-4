...
public class PrefsFragment extends PreferenceFragment implements
	...
	public boolean onPreferenceClick(Preference preference) {
		...
		if (preference.getKey().equals(PREFERENCES_ABOUT)) {
            ...
            new AlertDialog.Builder(this.getActivity())
                    .setTitle(this.getResources().getString(R.string.setting_aboutme_title))
                    .setView(webView)
	...
	private void showDialog( ) {
		...
		textView.setOnClickListener(new View.OnClickListener() {
			...
			String subTitle = new StringBuilder().append("V ").append(PhoneUtils.getPackageInfo(this.getActivity()).versionName).append("<br/>").toString();
